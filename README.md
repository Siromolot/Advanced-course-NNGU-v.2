...
***
_Запросы на jsonplaceholder не делал. Чтобы войти в проект, полагаю, нужно будет Вам там зарегистрироваться. Это не долго ) Откроется весь функционал. Также, можно сделать несколько аккаунтов, дабы проверить работоспособность некоторых компонентов, которые возвращают информацию (личные задачи) именно конкретного пользователя_
***
_А теперь как в кино: Приятного просмотра ) И заранее спасибо за обратную связь и за 4 месяца учебы_
***

CRM Samantha:
=====================

Предисловие: однажды вы сказали, что приветствуете инициативу и творческий подход. Это побудило меня задуматься о том, какой проект можно сделать, окромя блога со статьями. И я решил рассмотреть этот вопрос не с точки зрения просто выполнения домашнего задания, но с той точки зрения, а какую именно пользу может принести в будущем проект. И я пришел к выводу, что, во-первых, вам дейстительно может быть скучно проверять множество работ на одну и ту же тематику и, во-вторых, почему бы не попробовать сделать проект, который будет не номинально только для размещения в своем репозитории GitHub, но и в будущем, после соответствующей доработки и расширения функционала, сможет принести пользу компании. Надеюсь, у меня будет возможность уже в процессе работы спокойно допилить его и запустить в тех отделах компании, которые увидят в нем ценность.
***
...
P.S. В планах развить это приложение в полноценный продукт, чтобы оно было не просто системой управления взаимоотношениями с Клиентами, но стало и внутрикорпоративной системой, где:
 * группа админов (руководители отделов/направлений) могут создавать задачи для коллег и следить за ходом их выполнения;
 * в личном кабинете пользователя будет не только контактная информация, но и раздел о достижениях, которые были у сотрудника;
 * раздел статистики будет не столь скромным, а полномасштабным, отражающим динамику работы/выполнения задач конкретного пользователя и, возможно, отдела в целом;
 * и многое другое